 ...
 * text length falls within the configured bounds, shows a floating overlay that renders
 * the text into a styled image, copies it to the clipboard, and clears the field.
 */
@AndroidEntryPoint
class TextMonitorAccessibilityService : AccessibilityService() {
    ...
    override fun onServiceConnected() {
        ...
        overlayManager = OverlayWindowManager(this) { handleOverlayPressed() }
